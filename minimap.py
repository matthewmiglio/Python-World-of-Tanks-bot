...
def determine_general_direction(myself_coords,enemy_flag_coords):
    ...
    #determine directions
        #directions will be returned as an array denoting: [up,down,left,right] as either trues or falses
    directions=[False]*4
    ...
    if enemy_flag_coords[1]<myself_coords[1]:
        ...
        directions[0]=True
    if (not(directions[0]))and(not(directions[1]))and(not(directions[2]))and(not(directions[3])):
        return None
    return directions
...
def find_white_pix_on_minimap():
    ...
    black=Image.open(r"C:\Users\Matt\Desktop\1\my Programs\wot-bot\reference_images\draw_images\black2.png")
...
def draw_picture(coords):
    ...
    black_image=Image.open(r"C:\Users\Matt\Desktop\1\my Programs\wot-bot\reference_images\draw_images\black.png")
    ...
    while y_coord<60:
        ...
        while x_coord<60:
            ...
            if not (pixel_is_equal(pix,[200,200,200],tol=50)):
                ...
                if color=="red": red_pix_total=red_pix_total+1
                if color=="green": green_pix_total=green_pix_total+1
            x_coord=x_coord+1
        y_coord=y_coord+1
...
def cover_flag(flag_coords,ss):
    ...
    if (flag_coords is None)or(flag_coords =="unk"):
        return
    paste_image=Image.open(r"C:\Users\Matt\Desktop\1\my Programs\wot-bot\reference_images\paste_images\flag_cover.png")
